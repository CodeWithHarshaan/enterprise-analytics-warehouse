...
This repository is based on the open-source dbt "jaffle-shop" project and is used
as a portfolio example of building an enterprise-style analytics warehouse
using SQL and dbt for reporting and business intelligence.
